...
public class MigrationFacilityApplyController {
    ...
    private static final String filePath = "C:\\Users\\메이아이\\IdeaProjects\\mec_kongju_site\\src\\main\\resources\\jXlsTemplate\\facilityMigration.xls";
                ...
                while(cellItr.hasNext()) {
                    ...
                    switch (index) {
                        case 0 : // 첫 번째 열 (primary key)
                            facilityApplyVo.setFacilityApplySeq((Integer) getValueFromCell(cell));
                            break;
                        ...
                        case 5: // 여섯 번째 열 (startTime)
                            facilityApplyVo.setStartTime((int) getValueFromCell(cell));
                            break;
                        case 6: // 일곱 번째 열 (endTime)
                            facilityApplyVo.setEndTime((int) getValueFromCell(cell));
                            break;
